...
img_back = "FONN.jpg" #фон игры
img_bullet = "bullet.png" #пуля
img_hero = "FF.png" #герой
img_enemy = "NLOO.png" #враг
img_enemy2 = "AA.png" #враг2
score = 0 #сбито кораблей
goal = 15 #столько кораблей нужно сбить для победы
lost = 0 #пропущено кораблей
max_lost = 8 #проиграли, если пропустили столько
...
for i in range(1, 3):
   monster2 = Enemy2(img_enemy2, randint(80, win_width - 80), -40, 80, 50, randint(1, 2))
